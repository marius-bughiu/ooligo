...
Un prompt pack no es un skill. Un prompt es *reactivo* — lo provees en cada sesión; Claude lo aplica a lo que has dicho hasta ese momento y luego desaparece. Un prompt pack organizado en [Notion](/es/tools/notion/), un Google Doc o una carpeta de archivos `.txt` no persiste en el contexto de Claude automáticamente. No carga archivos de referencia. No puede disparar sub-pasos sin que tú los orquestes manualmente.
