...
Un Claude Skill que toma cualquier fila de lead, la corre contra la rúbrica ICP de tu equipo, y devuelve un score 0-10, una justificación por-criterio citando la rúbrica, una acción recomendada por tier y una bandera de escalación para casos borderline. Diseñado para enchufarse a una columna AI de Clay, una custom-code action de [HubSpot](/es/tools/hubspot/) o un run standalone de CLI sobre un CSV. Reemplaza la matriz de scoring en spreadsheet que nadie ha actualizado desde el año pasado — sin pretender que también puede hacer scoring de intent o conductual, que no puede.
