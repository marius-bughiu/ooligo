...
- **[NetDocuments](/de/tools/netdocuments/)** — die andere Hälfte des Legal-DMS-Duopols, von Anfang an cloud-nativ, berichtet mit 45–65 USD pro Nutzer und Monat für eine transaktionstaugliche Konfiguration, das AI-Add-on ndMAX für weitere 15–25 USD. Wählen Sie es, wenn Sie einen veröffentlichten Nutzerpreis für das AI-Add-on wollen und keine On-Premise-Altlast mitschleppen.
