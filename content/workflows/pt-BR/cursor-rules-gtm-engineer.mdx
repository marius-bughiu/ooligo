...
Um arquivo de [Cursor](/pt-BR/tools/cursor/) rules direcionado a GTM engineers que cabeiam o stack moderno de outbound: tabelas de Clay, campanhas de [Smartlead](/pt-BR/tools/smartlead/), enrichment do Apollo, orquestração com n8n e a inevitável cola de Python entre tudo. Empurra o modelo pra scripts pequenos e composáveis, tratamento explícito de rate limits e o tipo de observabilidade que sobrevive uma segunda de manhã.
