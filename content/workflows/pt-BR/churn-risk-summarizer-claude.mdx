...
Uma Claude Skill que roda toda manhã, puxa toda conta que cruzou um threshold de risco de churn nas últimas 24 horas e posta um digest de uma página num canal do [Slack](/pt-BR/tools/slack/): nome da conta, ARR em risco, o evento que dirigiu a mudança, o owner e uma próxima ação específica. Substitui o digest barulhento por email do [Gainsight](/pt-BR/tools/gainsight/) que a maioria dos CSMs já filtra para uma pasta, por algo apertado o suficiente para ler entre o standup e a primeira call com cliente.
