...
- **health score のインプット。** Gainsight、Catalyst、[Vitally](/ja/tools/vitally/)、[ChurnZero](/ja/tools/churnzero/) は health score を算出しますが、その精度は流し込まれる利用データ次第です。Mixpanel は、それらのスコアを支える「アカウント別の機能 X の採用率」のソースになることがよくあります。
