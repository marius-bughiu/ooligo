...
- **API-first and white-label.** The API and webhooks are first-class, which is why agencies and GTM engineers wire Smartlead into [Clay](/en/tools/clay/) and n8n flows; white-label client workspaces ($29/mo each) make it the agency default.
