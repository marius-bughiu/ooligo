...
- **ATS-native delivery.** Native [Workday](/en/tools/workday/) integration, plus [SmartRecruiters](/tools/smartrecruiters), [Greenhouse](/tools/greenhouse), Avature, PageUp, eArcu, and SAP SuccessFactors (via middleware), and a listing on the SAP Store — so the chat fires as a stage in your existing pipeline rather than a separate portal.
