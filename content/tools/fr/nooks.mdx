...
- **Write-back natif vers la couche d'engagement.** Nooks charge les tâches d'appel depuis Gong Engage, [Outreach](/fr/tools/outreach/) et Salesloft, puis journalise dispositions, notes et résumés en retour dans ces outils ainsi que dans Salesforce ou HubSpot, de sorte que le dialer ne devienne pas un système d'enregistrement parallèle.
