...
- **Sync avec le CRM et le CDP.** Sync bidirectionnel avec [HubSpot](/fr/tools/hubspot/) et [Salesforce](/fr/tools/salesforce/), plus Segment comme source et destination, poussent des événements comme Flow Started et Checklist Task Completed vers les systèmes que les CSM surveillent déjà.
