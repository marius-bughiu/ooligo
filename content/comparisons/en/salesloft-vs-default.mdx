...
- **No-code orchestration across the GTM stack.** Default talks to Salesforce, HubSpot, Clay, [Apollo](/en/tools/apollo/), calendars, and Slack to choreograph workflows that would otherwise need a Salesforce admin and a Workato build.
