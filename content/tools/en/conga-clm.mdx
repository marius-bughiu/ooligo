...
- Implementation usually 90-180 days, often led by Salesforce partners; faster than [Icertis](/en/tools/icertis/) or [Agiloft](/en/tools/agiloft/) for Salesforce-mature shops.
...
- AI features (Conga AI) are improving but lag [Ironclad](/en/tools/ironclad/) AI and Spellbook on quality
