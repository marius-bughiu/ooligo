...
[Ironclad](/en/tools/ironclad/) and [LinkSquares](/en/tools/linksquares/) are the two most common shortlist finalists for mid-market and enterprise CLM. Ironclad started as a workflow engine for contract creation and approval — the front end of the contract lifecycle. LinkSquares started as an AI-driven repository for executed contracts — the back end. Both have grown into each other's space, but the DNA still shows in the product.
