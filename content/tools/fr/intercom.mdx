...
- **Support connecté au CRM.** Des intégrations Salesforce et [HubSpot](/fr/tools/hubspot/) étroites permettent aux événements de support d'alimenter le risque de renouvellement, les signaux d'expansion et les workflows CSM.
