...
**Sendspark** and **Dubb** are the fastest-growing entrants in the category. Sendspark focuses on personalized video landing pages with built-in CTAs at ~$49/user/month; Dubb adds exit-intent pop-ups and direct [Calendly](/en/tools/calendly/) integration at comparable pricing. Both undercut Vidyard's Teams plan by $40-50/user/month. Pick them when budget is the constraint and your sequencer doesn't need a deep native embed; pick Vidyard when the Salesloft or Outreach integration is the whole point.
