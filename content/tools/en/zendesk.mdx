...
- **It is the system of record for the customer's voice.** Every ticket, escalation, and CSAT response lands here. Health-score tools like [Gainsight](/en/tools/gainsight/) and [Vitally](/en/tools/vitally/) pull Zendesk ticket volume and sentiment as a churn-risk signal, which is why the integration matters more than the UI.
