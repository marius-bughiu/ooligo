...
- **It sits upstream of the CSM handoff.** Rocketlane owns onboarding; [Gainsight](/en/tools/gainsight/), Vitally, ChurnZero, or Catalyst own the recurring lifecycle after go-live. The Salesforce/HubSpot sync means a closed-won deal spawns a project automatically with account context attached.
