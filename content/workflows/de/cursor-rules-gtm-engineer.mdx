...
Eine [Cursor](/de/tools/cursor/)-Regeldatei für GTM-Engineers, die den modernen Outbound-Stack verdrahten: Clay-Tabellen, [Smartlead](/de/tools/smartlead/)-Kampagnen, Apollo-Anreicherung, n8n-Orchestrierung und den unvermeidlichen Python-Kleber dazwischen. Lenkt das Modell in Richtung kleiner, komponierbarer Skripte, expliziter Rate-Limit-Behandlung und der Art von Observability, die einen Montagmorgen überlebt.
