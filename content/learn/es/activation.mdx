...
El evento de activación debe ser específico, conductual y predictivo. "Inició sesión" no es activación. "Envió un mensaje en [Slack](/es/tools/slack/) en un canal con al menos otra persona dentro de los siete días desde el signup" sí lo es. La prueba es la correlación: usuarios que hacen el evento retienen a tasas significativamente más altas que usuarios que no.
