...
4. **Mappez le stockage du plan de succès.** Choisissez l'une des options Notion, objet personnalisé Salesforce ou CTA Gainsight, et tenez-vous-y. Le résolveur `success_plan_ref` du skill suppose un emplacement de stockage canonique unique par compte. Le stockage mixte est la cause la plus courante du « le skill dit que mon plan est manquant alors qu'il ne l'est pas ».
