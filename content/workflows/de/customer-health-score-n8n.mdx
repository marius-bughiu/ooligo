...
Eine dritte Alternative sind **die eingebauten Health-Scores von Catalyst, [ChurnZero](/de/tools/churnzero/) oder Vitally**. Das sind gute Produkte mit eigenen Scoring-Engines, aber sie setzen voraus, dass Sie auf deren CSP standardisiert haben. Wenn Sie bereits Catalyst-Kunde sind, verwenden Sie Catalysts Score und fügen Sie den Why-Changed-Claude-Call als Catalyst-Aktion hinzu; die Mathematik ist dieselbe. Dieser Workflow existiert, weil die meisten Teams in der Praxis noch auf Gainsight sind und der Gainsight-Write-Back der Teil ist, der das Bundle rechtfertigt.
