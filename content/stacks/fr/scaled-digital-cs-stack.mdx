...
- **[Totango](/en/tools/totango/) est la plateforme de Customer Success et le système d'enregistrement du health des comptes.** Il agrège l'usage produit, les tickets de support, le NPS/CSAT et les données CRM dans un health score pondéré, puis déclenche des SuccessPlays sur des *segments* de comptes plutôt que sur des comptes individuels&nbsp;: cette automatisation au niveau du segment est précisément la raison pour laquelle il ancre une motion one-to-many. Son moteur d'intelligence Unison AI (le troisième pilier du portefeuille Totango/Catalyst d'après 2024) classe désormais la base selon les signaux de churn et d'expansion, si bien que le segment visé par une play est scoré par le modèle plutôt que monté à la main. Quand un health score franchit un seuil de risque, Totango déclenche la play&nbsp;; quand [ChurnZero](/en/tools/churnzero/) renvoie un événement in-app, cela devient un input du score.
