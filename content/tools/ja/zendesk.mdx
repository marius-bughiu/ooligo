...
- **顧客の声の system of record である。** すべてのチケット、エスカレーション、CSAT 回答がここに集まります。[Gainsight](/ja/tools/gainsight/) や [Vitally](/ja/tools/vitally/) のような health-score ツールは、Zendesk のチケット量と sentiment を churn リスクのシグナルとして取り込みます。だからこそ UI 以上に連携が重要になります。
