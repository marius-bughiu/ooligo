...
A different shape — [Perplexity](/en/tools/perplexity/) is search-anchored AI rather than a general assistant. For the use case of "find current information and synthesize," Perplexity is genuinely better than ChatGPT, with citations and real-time web grounding as defaults rather than features.
