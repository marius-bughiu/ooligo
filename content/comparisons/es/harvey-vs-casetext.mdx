...
Harvey y [Casetext](/es/tools/casetext/) (ahora parte de Thomson Reuters como CoCounsel) apuntan al mismo comprador —firmas grandes y áreas legales corporativas— pero desde direcciones opuestas. Harvey nació AI-first y se vendió a firmas de élite. Casetext venía de investigación legal y fue adquirida por TR en 2023, dándole la columna vertebral de Westlaw. Elegir entre ambos es realmente elegir entre "modelo frontier sobre los datos de tu firma" y "base de datos profunda de investigación legal con IA encima".
