...
- **The control surface for everything else.** Salesforce, [HubSpot](/en/tools/hubspot/), Greenhouse, Ironclad — they all post to Slack and accept actions from Slack.
...
- Slack AI quality is improving but trails [ChatGPT](/en/tools/chatgpt/)/[Claude](/en/tools/claude/) for general reasoning
