...
- **Cualquier fuente CSV** —el prompt lee columnas, no Gainsight específicamente; reapunta el manifesto a un export de Catalyst, Vitally o [ChurnZero](/es/tools/churnzero/) y funciona igual
