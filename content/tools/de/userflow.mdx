...
- **Sync mit CRM und CDP.** Bidirektionaler Sync mit [HubSpot](/de/tools/hubspot/) und [Salesforce](/de/tools/salesforce/) sowie Segment als Source und Destination schieben Events wie Flow Started und Checklist Task Completed in die Systeme, die CSMs ohnehin im Blick haben.
