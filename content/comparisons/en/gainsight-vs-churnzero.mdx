...
- **HubSpot-first stacks.** If your CRM is [HubSpot](/en/tools/hubspot/) rather than Salesforce, ChurnZero's integration is materially stronger. Gainsight's HubSpot connector works, but Salesforce is the first-class citizen in its data model.
