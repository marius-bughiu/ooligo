...
Demandez un benchmark d'un client dans un segment similaire, à un volume similaire. S'ils ne peuvent pas en fournir un, demandez le taux de réponse médian sur leur base clients. Des taux de réponse inférieurs à 3 pour cent en cold outbound à volume indiquent que la personnalisation ne fonctionne pas.
