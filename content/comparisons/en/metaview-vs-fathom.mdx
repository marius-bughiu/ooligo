...
- **ATS integration depth.** Metaview pushes structured feedback directly into Greenhouse, [Lever](/en/tools/lever/), and Ashby. Fathom integrates with CRMs first; ATS integration is shallower.
...
Fathom has a generous free tier and per-seat paid plans in the low tens of dollars per month. Metaview is enterprise-priced — five-figure annual minimum, scaling with interviewer headcount. For a small company doing occasional interviews, Fathom is the obvious pick. For a recruiting team running 200+ interviews a month, [Metaview](/en/tools/metaview/)'s structured output and ATS integration justify the premium.
