...
- **WestlawとPractical Lawへのネイティブアクセス。** リサーチ中心の業務において、[Harvey](/ja/tools/harvey/)や[Spellbook](/ja/tools/spellbook/)に対する最大の堀です。引用は事務所がすでにアクセス権を持つ実在の判例に解決され、ハルシネーションされた判例名にはなりません。
