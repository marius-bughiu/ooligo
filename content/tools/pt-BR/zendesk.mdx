...
- **É o sistema de registro da voz do cliente.** Cada ticket, escalação e resposta de CSAT cai aqui. Ferramentas de health-score como [Gainsight](/pt-BR/tools/gainsight/) e Vitally puxam o volume de tickets e o sentimento do Zendesk como sinal de risco de churn, por isso a integração importa mais que a UI.
