...
- **It's not a CS platform.** Front handles communication, not health scores, renewal forecasting, or playbooks. Pair it with Gainsight, Vitally, or [ChurnZero](/en/tools/churnzero/) for the actual CS workflow; Front is the inbox layer, not the system of record for NRR/GRR.
