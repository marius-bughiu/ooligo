...
3. **Ausgabeformat konfigurieren.** Das Standard-Output ist ein Markdown-Brief mit fünf Abschnitten. Bearbeiten Sie `SKILL.md`, wenn Ihr Team Notion-Blocks, ein Google Doc oder eine Slack-freundliche Zusammenfassung bevorzugt.
