...
- **MCP server support.** Plug any MCP server into Cursor — Salesforce, HubSpot, [Linear](/en/tools/linear/), your CRM-of-choice — and the AI can read/write data while writing code that uses it.
