...
Ask for a benchmark from a customer in a similar segment, at a similar volume. If they cannot provide one, ask for the median reply rate across their customer base. As a rough rule of thumb, an estimated sub-3 percent reply rate on cold outbound at volume is a sign the personalization is not working.
