...
- **Microsoft Dynamics + Oracle CX coverage.** Stronger non-[Salesforce](/en/tools/salesforce/) CRM coverage than Clari; meaningful for enterprise teams not on Salesforce.
