...
**Price per rep, by a wide margin.** Customer-reported pricing places mid-market BoostUp deployments at $100-$250 per seat per year — roughly $8-20 per rep per month. Clari's core platform runs $100-120 per user per month, with all-in costs for a fully-deployed team reaching $200+/user/month when Copilot and professional services are included. For a 75-rep team, that gap is $700K-$1.1M over three years. At that difference, BoostUp doesn't need to match Clari feature-for-feature; it needs to be good enough on the things that matter most, and for mid-market forecasting it is.
...
Clari's median annual contract runs roughly $160,000, with a fully-loaded per-user cost pushing toward $200+/month for teams using core platform plus Copilot. BoostUp customer reports place mid-market deployments (50-200 reps) at $100-$250 per seat per year — call it $8-20/seat/month — significantly below Clari for comparable forecasting scope. At the 300-rep enterprise band both companies negotiate hard; Clari's pricing floor drops with volume and multi-year commits. The post-Terret-rebrand pricing has not been published publicly, but the positioning remains explicitly mid-market-accessible.
