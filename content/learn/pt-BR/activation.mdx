...
O evento de ativação deve ser específico, comportamental e preditivo. "Logou" não é ativação. "Mandou uma mensagem no [Slack](/pt-BR/tools/slack/) em um canal com pelo menos uma outra pessoa dentro de sete dias do signup" é. O teste é correlação: usuários que fazem o evento retêm em taxas significativamente mais altas que usuários que não.
