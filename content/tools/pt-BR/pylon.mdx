...
- **É encanamento genuinamente nativo de IA.** Um servidor MCP hospedado pela Pylon (mcp.usepylon.com, OAuth) permite que Claude ou [Cursor](/pt-BR/tools/cursor/) consultem e atualizem issues e contas, além de uma REST API documentada e webhooks para o long tail.

## Pricing

O Pylon tirou o pricing público do ar. `usepylon.com/pricing` agora redireciona com 301 para o agendamento de demo, então cada número abaixo é a **última tarifa publicada** e não uma que você consiga verificar hoje — use como âncora de negociação, não como cotação. Última publicada, por assento e faturado anualmente: Starter $59/assento/mês, Professional $89/assento/mês, Enterprise $139/assento/mês. Starter e Professional tinham um mínimo de 3 assentos; Enterprise precisava de 7 (ou seja, um piso de ~$973/mês). Não havia tier free, só trial. A IA é onde a conta crescia: os AI Assistants somavam $50/assento/mês, os AI Agents começavam em $100/mês e escalavam com o volume de issues de 30 dias, e o Account Intelligence custava $10 por conta de cliente/mês (mínimo de 50 contas). Um time pequeno que queira o stack completo de IA deve orçar bem acima do preço de assento da capa — realisticamente $130-200 por assento tudo incluído depois que Assistants e Agents estão ativos.
...
- **O pricing agora está atrás de uma demo, e os add-ons de IA são onde o custo real aparece.** Os $59 da capa de antes eram um assento da plataforma base; as features de deflexão e sinais que justificam escolher o Pylon eram todas medidas por cima. O guard: peça que vendas cote Assistants + Agents + Account Intelligence como linhas separadas contra seu número de assentos e volume de issues já na primeira call, e confirme a tarifa por assento diretamente em vez de confiar numa listagem de terceiros que copiou a antiga página pública.
