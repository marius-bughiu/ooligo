...
- **Vorurteilsreduzierung ohne Prozess-Redesign.** Karats Rubric-gesteuertes Format entfernt Lebenslauf-basierte Hinweise aus dem Interview-Schritt selbst — dort liegt auch das Equity-Versprechen des Unternehmens. Die Series-C-Runde 2021 nannte als zentrales Ergebnis eine Steigerung von 60 % bei unterrepräsentierten Kandidaten, die technische Screenings passierten. Der Mechanismus ist auditierbar: Jedes Interview wird aufgezeichnet.
