...
- **It sits upstream of the CSM handoff.** Rocketlane owns onboarding; [Gainsight](/en/tools/gainsight/), Vitally, [ChurnZero](/en/tools/churnzero/), or Catalyst own the recurring lifecycle after go-live. The Salesforce/HubSpot sync means a closed-won deal spawns a project automatically with account context attached.
...
- **Nitro is new and add-on-priced.** The agentic claims (50% manual-effort reduction at [Glean](/en/tools/glean/), Notion) are vendor-reported and not in the base seat price. The guard: pilot Nitro on a subset of projects and measure plan-accuracy before rolling it org-wide or budgeting on its savings.
