...
4. **Mapeie o armazenamento do plano de sucesso.** Escolha um de Notion, objeto customizado do Salesforce ou [Gainsight](/pt-BR/tools/gainsight/) CTA e mantenha-o. O resolver `success_plan_ref` do skill assume um único local de armazenamento canônico por conta. Armazenamento misto é a causa mais comum de "o skill diz que meu plano está faltando quando não está".
