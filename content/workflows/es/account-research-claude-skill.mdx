...
3. **Configura el formato de salida.** El output por defecto es un brief en Markdown con cinco secciones. Edita `SKILL.md` si tu equipo prefiere bloques de [Notion](/es/tools/notion/), un Google Doc o un resumen para Slack.
...
- **Datos públicos desactualizados.** El scraping de LinkedIn se rompe seguido y los transcripts de earnings tienen un trimestre de retraso. Si la frescura importa, agrega arriba una fuente de pago como [ZoomInfo](/es/tools/zoominfo/) o Apollo.
