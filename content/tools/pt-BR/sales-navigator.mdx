...
- **InMail como canal.** Onde cold email não chega, o InMail às vezes chega. Todo tier inclui um pool mensal de 50 créditos de InMail.

## Realidade do pricing

- **Core** — US$ 119,99/usuário/mês na cobrança mensal, ou ~US$ 89,99/usuário/mês no compromisso anual (US$ 1.079,88/ano)
- **Advanced** — US$ 159,99/usuário/mês na cobrança mensal, ou ~US$ 149,99/usuário/mês anual (US$ 1.799,88/ano); adiciona sync com CRM, list-share, filtros de busca avançados
- **Advanced Plus (Enterprise)** — custom, tipicamente US$ 1.600-US$ 2.500/seat/ano; adiciona SSO enterprise, writeback no CRM, reporting avançado e controles de admin mais amplos

Os três tiers agora carregam os mesmos 50 créditos de InMail/mês, então o pool de créditos não é mais motivo para subir de tier. O compromisso anual é o verdadeiro ponto de entrada: o LinkedIn anuncia o valor da cobrança mensal mas dá desconto de cerca de 25% no Core (por volta de 6% no Advanced) pelo prazo anual. Deployments mid-market (50-200 reps) tipicamente padronizam no Advanced anual perto de US$ 150/seat; compras enterprise negociam o Advanced Plus na faixa de US$ 1.600-US$ 2.000/seat/ano com volume.
