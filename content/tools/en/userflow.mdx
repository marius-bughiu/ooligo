...
- **CRM and CDP sync.** Two-way HubSpot and [Salesforce](/en/tools/salesforce/) sync, plus Segment as both source and destination, push events like Flow Started and Checklist Task Completed into the systems CSMs already watch.
