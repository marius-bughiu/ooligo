...
A cadência certa é semanal — tipicamente na segunda-feira de manhã, antes da reunião de revisão de contas da equipe — e a saída certa é um [Slack](/pt-BR/tools/slack/) DM pessoal por CSM, limitado a três sinais fortes cada. O limite importa: em pilotos, um digest de CSM com 10 ou mais "contas engajadas" é lido por duas semanas e depois ignorado permanentemente. Três pedidos concretos por semana, repetidos toda segunda-feira, é a cadência que a equipe realmente internaliza.
