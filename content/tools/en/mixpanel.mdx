...
- **Health-score inputs.** Gainsight, Catalyst, [Vitally](/en/tools/vitally/), and ChurnZero compute health scores, but they're only as good as the usage data piped in. Mixpanel is often the source of "feature X adoption per account" that feeds those scores.
