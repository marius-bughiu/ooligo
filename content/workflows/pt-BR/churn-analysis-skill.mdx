...
**Passo 2 — evidence pass.** Um primeiro pass do Claude que SÓ extrai evidência: citações verbatim, trechos de tickets, deltas de métricas com a fonte (CRM, [Gainsight](/pt-BR/tools/gainsight/), Zendesk, Gong) e data. Sem classificação, sem recomendação de prevenção. O output é uma lista flat de linhas de evidência mantida como artifact intermediário.
