...
3. **Configure output format.** The default output is a Markdown brief with five sections. Edit `SKILL.md` if your team prefers [Notion](/en/tools/notion/) blocks, a Google Doc, or a Slack-friendly summary.
...
- **Stale public data.** LinkedIn scraping breaks frequently and earnings transcripts lag a quarter. If freshness matters, layer a paid source like [ZoomInfo](/en/tools/zoominfo/) or Apollo upstream.
