...
1. **Bundle importieren.** Legen Sie `apps/web/public/artifacts/inbound-lead-triage-n8n/inbound-lead-triage-n8n.json` über **Workflows → Aus Datei importieren** in n8n. Der Flow hat zwei Einstiegspunkte: einen Webhook für den Echtzeit-Pfad und einen täglichen Cron für den Backstop-Sweep.
