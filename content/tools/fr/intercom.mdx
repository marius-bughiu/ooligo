...
- **Support connecté au CRM.** Des intégrations [Salesforce](/fr/tools/salesforce/) et [HubSpot](/fr/tools/hubspot/) étroites permettent aux événements de support d'alimenter le risque de renouvellement, les signaux d'expansion et les workflows CSM.
...
- Moins adapté aux flux de ticketing complexes en entreprise que [Zendesk](/fr/tools/zendesk/) ou Salesforce Service Cloud
